...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<ModelRegistro> getAllDebiti() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                String selectDescrizioneQuery = "SELECT  * FROM " + TABLE_DESCRIZIONE_DEBITO +" WHERE "+KEY_ID+" = "+ modelRegistro.getId();
                ...
                String selectImportoQuery = "SELECT  * FROM " + TABLE_IMPORTO_DEBITO+" WHERE "+KEY_ID+" = "+ modelRegistro.getId();;
                ...
                String selectDataQuery = "SELECT  * FROM " + TABLE_DATA_DEBITO+" WHERE "+KEY_ID+" = "+ modelRegistro.getId();;
